<div class="sidebar">
    <div class="sidebar-header">
        <div class="sidebarNavButton">
            <button class="menu" aria-label="Toggle sidebar" aria-haspopup="true">
                <svg class="fluentIcon ___12fm75w f1w7gpdv fez10in fg4l7m0" fill="currentColor" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 4.5c0-.28.22-.5.5-.5h15a.5.5 0 010 1h-15a.5.5 0 01-.5-.5zm0 5c0-.28.22-.5.5-.5h15a.5.5 0 010 1h-15a.5.5 0 01-.5-.5zm.5 4.5a.5.5 0 000 1h15a.5.5 0 000-1h-15z" fill="currentColor"></path>
                </svg>
            </button>
        </div>
    </div>
            ...
            <ul role="listbox" class="ms-FocusZone css-41 lists" data-focuszone-id="FocusZone18">
                <li class="mt-3 {{Request::segment(2) == "home" ? "active" : ""}}" tabindex="0" role="option" aria-selected="false">
                    <a href="{{route('todo.index', 'home')}}" class="d-flex align-items-center">
                        ...
                        <div class="homeToolbar-title mt-1">
                            <span>Home</span>
                        </div>
                        <div class="homeToolbar-count" aria-hidden="true"></div>
                    </a>  
                </li>
                <li class="mt-3 {{Request::segment(2) == "myday" ? "active" : ""}}" tabindex="0" role="option" aria-selected="false">
                    <a href="{{route('todo.index', 'myday')}}" class="d-flex align-items-center">
                        <div aria-hidden="true" class="me-4">
                        ...
                        <div class="todayToolbar-title mt-1">
                            <span>My Day</span>
                        </div>
                        <div class="todayToolbar-count" aria-hidden="true"></div>
                    </a>
                </li>
                <li class="mt-3 {{Request::segment(2) == "important" ? "active" : ""}}" tabindex="0" role="option" aria-selected="false">
                    <a href="{{route('todo.index', 'important')}}" class="d-flex align-items-center">
                        <div aria-hidden="true" class="me-4">
                            <svg class="fluentIcon ___12fm75w f1w7gpdv fez10in fg4l7m0" fill="currentColor" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" 
                            xmlns="http://www.w3.org/2000/svg" focusable="false">
                        ...
                        <div class="importantToolbar-title mt-1">
                            <span>Important</span>
                        </div>
                        <div class="importantToolbar-count" aria-hidden="true"></div>
                    </a>
                </li>
                <li class="mt-3 {{Request::segment(2) == "plan" ? "active" : ""}}" tabindex="0" role="option" aria-selected="false">
                    <a href="{{route('todo.index', 'plan')}}" class="d-flex align-items-center ">
                        <div aria-hidden="true" class="me-4">
                            <span class="listItem-icon">
                                <svg class="fluentIcon ___12fm75w f1w7gpdv fez10in fg4l7m0" fill="currentColor" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" 
                                xmlns="http://www.w3.org/2000/svg" focusable="false">
                        ...
                        <div class="planToolbar-title mt-1">
                            <span>Plan</span>
                        </div>
                        <div class="planToolbar-count" aria-hidden="true"></div>
                    </a>
                </li>
            </ul>
        </nav>
